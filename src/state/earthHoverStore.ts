...
export const CRAFT: Craft[] = [
  {
    ...
    orbit: { radius: 1.2, tiltA: 0.15, tiltB: -0.1, phase: 0.5, speed: 0.05, dir: 1 },
  ...
  },
  {
    ...
    orbit: { radius: 1.45, tiltA: -0.5, tiltB: 0.25, phase: 1.4, speed: 0.07, dir: -1 },
  ...
  },
  {
    ...
    orbit: { radius: 0.95, tiltA: 0.45, tiltB: 0.2, phase: 2.5, speed: 0.1, dir: 1 },
  ...
  },
  {
    ...
    orbit: { radius: 1.3, tiltA: 0.2, tiltB: -0.45, phase: 3.2, speed: 0.06, dir: -1 },
  ...
  },
  {
    ...
    orbit: { radius: 1.5, tiltA: -0.3, tiltB: -0.2, phase: 4.0, speed: 0.045, dir: 1 },
  ...
  },
  {
    ...
    orbit: { radius: 1.15, tiltA: -0.45, tiltB: 0.4, phase: 5.0, speed: 0.065, dir: -1 },
  ...
  },
  {
    ...
    orbit: { radius: 1.4, tiltA: 0.4, tiltB: 0.35, phase: 0.9, speed: 0.05, dir: 1 },
  ...
  },
  {
    ...
    orbit: { radius: 0.9, tiltA: 0.55, tiltB: -0.25, phase: 2.0, speed: 0.11, dir: -1 },
